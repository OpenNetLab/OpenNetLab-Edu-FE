            ...
            <li>
              <Dropdown @on-click="handleResultChange">
                ...
                <Dropdown-menu slot="list">
                  ...
                  <!--状态筛选，需要的是judging和pedding，暂定为该用户所有的未完成的提交-->
...
<script>
  ...
  export default {
    ...
    // TaskInRunning 显示所有judging和pedding的Topic提交，不论身份，
    // All代表所有，Mine代表仅自己
    methods: {
      init () {
    ...
    computed: {
      ...
      title () {
        return this.$i18n.t('m.RunningTask')
        // if (!this.contestID) {
