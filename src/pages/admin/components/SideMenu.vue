<template>
  <el-menu class="vertical_menu"
    ...
    <div class="logo">
      <img src="../../../assets/ONLicon.png" alt="oj admin" @click="goHome"/>
    </div>
    ...
    <el-submenu index="topic" v-if="hasProblemPermission">
    ...
    <el-submenu index="lab" v-if="isAdminRole">
      ...
      <el-menu-item index="/lab">{{$t('m.Contest_List')}}</el-menu-item>
      <el-menu-item index="/lab/create">{{$t('m.Create_Contest')}}</el-menu-item>
    </el-submenu>
  </el-menu>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      goHome () {
        window.open('http://172.16.1.209:8080')
      }
    },
    computed: {
