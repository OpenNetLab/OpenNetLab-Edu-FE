export const m = {
  ...
  You_have_solved_the_problem: 'You have solved this lab',
  Submitted_successfully: 'Submitted successfully',
  You_have_submitted_a_solution: 'You have submitted a solution.',
  Contest_has_ended: 'Course has ended',
  You_have_submission_in_this_problem_sure_to_cover_it: 'You have submission in this lab, sure to cover it?',
  // About.vue
  Compiler: 'Compiler',
  Result_Explanation: 'About OpenNetLab',
  ...
  Rating: 'Rating',
  // Announcements.vue
  Contest_Announcements: 'Course Announcements',
  By: 'By',
  ...
  Ended: 'Ended',
  No_contest: 'No course data',
  Please_login_first: 'Please login first!',
  // ContestProblemList
  Problems_List: 'Labs List',
  No_Problems: 'No lab data',
  // CodeMirror.vue
  Language: 'Language',
  Theme: 'Theme',
  ...
  NavProblems: 'Labs',
  Contests: 'Courses',
  NavStatus: 'Lab Status',
  Net_info: 'ONL net nodes',
  NodeInUse: 'Node in use',
  TaskInRunning: 'Task in running',
  About: 'About',
  About_ONL: 'About ONL',
  FAQ: 'FAQ',
  Login: 'Login',
  ...
  UserLogin: 'Login',
  Welcome_back: 'Welcome back to ONL',
  // OIRank.vue
  OI_Ranklist: 'OI Ranklist',
  // OIContestRank.vue
  Total_Score: 'Total Score',
  // ProblemList.vue
  Problem_List: 'Lab List',
  High: 'High',
  Mid: 'Mid',
  Low: 'Low',
  All: 'All',
  ...
  Problem_Submissions: 'Lab Submissions',
  Submission_limit: 'Your number of submissions has reached the upper limit.',
  UstcEmail: 'The email address does not comply with USTC specifications',
  Judge_Server_List: 'Judge Server List',
